        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Convocation::class)
                        <x-dropdown-link href="{{ route('convocations.index') }}">
                        Convocations
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Inscription::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Convocation::class)
                <x-jet-responsive-nav-link href="{{ route('convocations.index') }}">
                Convocations
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Inscription::class)
                <x-jet-responsive-nav-link href="{{ route('inscriptions.index') }}">
                Inscriptions
                </x-jet-responsive-nav-link>
                @endcan
